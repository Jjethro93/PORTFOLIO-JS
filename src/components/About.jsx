...
function About({ darkMode }) {
    ...
    items-center justify-center px-4 sm:px-6 ${darkMode ? 'bg-grau-900' : 'bg-gray-50'
            }
        ...
        gap-8 sm:gap-12 items-center">
            ...
            order-2 lg:order-1">
                    ...
                    to-[#f59e0b] rotate-12 star-shape z-0"
                        ...
                        object-cover z-10 transition-all durantion-300"
                            data-aos='zoom-in'
                            data-aos-delay='400' />
                    </div>
            ...
            lg:order-2 ">
                    <header >
                        <h1 className="text-3xl lg:text-5xl sm:text-4xl
            ...
            text-transparent bg-linear-to-r from-orange-400 to-orange-600 bg-clip-text"
                ...
                sm:mb-8">
                    ...
                    <button
                        onClick={() =>
                            window.open(
                                "https://www.linkedin.com/in/jethro-sufra7/",
                                "_blank"
                            )
                        }
                        className={`w-full sm:w-auto
                                inline-flex items-center border-2
                                border-orange-500  
                                justify-center 
